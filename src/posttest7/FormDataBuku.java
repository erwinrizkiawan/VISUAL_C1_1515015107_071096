...
//    private Object jTable1;
    ...
    public boolean HapusData(String id){
        try{
            String sql ="UPDELETE FROM buku WHERE id="+id+";";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Data Sudah Ada, Coba Yang Lain!");
        }
        else
        {
...
InitTable();TampilData();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        // TODO add your handling code here:
                ...
                comboPenulis.setSelectedItem(jTable1.getValueAt(baris,
                        2).toString());
